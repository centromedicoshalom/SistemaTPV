...
/**
 * LaboratoriopacienteSearch represents the model behind the search form of `app\models\Persona`.
 */
class LaboratoriopacienteSearch extends Persona
{
    /**
     * {@inheritdoc}
     */
